        ...
        },
        {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    content:
                        "The setup flow's own modes and levels are covered by that surface's tests, including the rule that a funny level can never reach the consent facts. appCopy.test.ts additionally proves, for the catalogue's 917 voiced entries: five levels in both languages, no empty string, level 1 reading differently from level 5, the same placeholders surviving every level, and every required fact surviving every level in both languages. Its other 1419 entries are fixed labels -- one string per language rather than five, so a funny level has nothing on them to vary -- and still get the no-empty-string and no-em-dash checks everything in the catalogue gets: 2336 keys in total. The contract's list is about every message in every surface, and the surfaces not yet on the covered list are the part still untested, not the whole application.",
                },
            ],
        },
    ],
