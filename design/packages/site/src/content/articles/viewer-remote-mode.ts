        ...
        },
        {
            ...
            blocks: [
                ...
                },
                {
                    kind: "callout",
                    tone: "warning",
                    title: "Open defects on the desktop shell",
                    content: [
                        "Two issues are open against the window this viewer runs inside: ",
                        ...
                        ", the window not being frameless and having no custom Material title bar. Check the ",
                        "tracker for their current state before assuming either is resolved.",
                    ],
                },
            ],
        },
