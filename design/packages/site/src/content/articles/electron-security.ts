        ...
        },
        {
            ...
            blocks: [
                ...
                },
                {
                    kind: "callout",
                    tone: "note",
                    title: "The window is frameless now, and draws its own chrome",
                    content: [
                        "This article used to say the opposite, and it was true when it was written. The ",
                        "window is now created with no frame at all, so the operating system's caption bar ",
                        "never appears as product chrome, and the application draws its own Material title bar ",
                        "with its own window buttons. Two captures of it are committed to the repository. That ",
                        "work is tracked as ",
                        { link: "#5", href: issue(5), external: true },
                        "; check the tracker for its current state rather than reading this line as a closure.",
                    ],
                },
            ],
        },
