...
export interface ShapeMarkerDataInput extends ObjectMarkerDataInput {
...
export class ShapeMarker extends ObjectMarker {
    declare readonly isShapeMarker: boolean;

    fill: ShapeMarkerFill;
    border: ShapeMarkerBorder;

    _markerData: ShapeMarkerDataInput;
    ...
    override updateFromData(markerData: ShapeMarkerDataInput): void {
        ...
        // update border-color
        const bc = markerData.lineColor || markerData.borderColor || {}; //"borderColor" for backwards compatibility
...
class ShapeMarkerFill extends Mesh<ShapeGeometry, ShaderMaterial> {
    constructor(shape: Shape) {
        const geometry = ShapeMarkerFill.createGeometry(shape);
    ...
    static createGeometry(shape: Shape): ShapeGeometry {
