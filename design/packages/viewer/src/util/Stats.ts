...
interface StatsPanelConstructor {
    new (name: string, fg: string, bg: string): StatsPanel;
    (name: string, fg: string, bg: string): StatsPanel;
}

interface StatsConstructor {
    new (): Stats;
    (): Stats;
    Panel: StatsPanelConstructor;
}
...
let Stats = function (): Stats {
    ...
    if (
        self.performance &&
        (self.performance as Performance & { memory?: PerformanceMemory }).memory
    ) {
