...
| Pages | Material 3 GitHub Pages shell, tabbed discovery, repository-backed changelog, command palette, notification centre and responsive documentation surface | **Source/type/lint/build gates pass locally; 132 site tests pass across 16 files. The current continuation adds every-rendered-element appearance coverage, dynamic per-group discovery searches, and searchable tab/group/overflow menus with adjacent builders. Hosted CI/Pages proof remains outstanding; runtime/headless capture remains a separate boundary** |
