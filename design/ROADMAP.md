...
| Pages | Material 3 GitHub Pages shell, tabbed discovery, repository-backed changelog, command palette, notification centre and responsive documentation surface | **Source/type/lint/build gates pass; 36 focused site tests pass. Full monorepo tests remain red on pre-existing CRLF HOCON fixtures and `@material-bluemap/nbt` package resolution. Runtime/headless capture is still separate** |
